...
This directory contains notebooks that generate publication-ready figures from processed data.

## Purpose

These notebooks load processed data from `/processed_data/` and create publication-quality figures saved to `/figures/`.
